		...
		<header class="entry-header">
            <div class="v-container">
                ...
                <?php
                            ...
                            ?>
                            <p><?php echo esc_html_e( 'เรื่อง' , 'computerdesk' ); ?><a href="<?php echo esc_url( get_author_posts_url( get_the_author_meta( 'ID' ) ) ); ?>"><span><?php echo $first_name; ?></span><span><?php echo $last_name; ?></span></a></p>
                </div>
            </div>
		</header><!-- .entry-header -->
	...
	<?php
		...
		?>
            ...
            <div class="box-list_single">
                <div class="v-container">
                    <div class="tag-box">
                        <p><?php echo esc_html_e( 'Tags:' , 'computerdesk' ); ?></p>
                ...
                <div class="v-container">
                    <div class="grid-author_box">
                        <div class="object-1">
                            <div class="author_a">
                                <div class="title_text">
                                    <p><?php echo esc_html_e( 'Author:' , 'computerdesk' ); ?></p>
                                </div>
                        ...
                        ?>
                            <div class="author_b">
                                <div class="title_text">
                                    <p><?php echo esc_html_e( 'Photographer:' , 'computerdesk' ); ?></p>
                                </div>
                                <div class="object-detail">
                                    <div class="avatar">
            ...
            <div class="v-container">
                <div class="main-recent-post">
                    <div class="title_recent">
                        <h3><?php echo esc_html__( 'Related Posts' , 'computerdesk'); ?></h3>
                    </div>
                    ...
                    <?php
                            ...
                            get_template_part(  'template-parts/content-card', 'card' );
                            endwhile;
                            // Reset Query
                            wp_reset_query();
                    ?>
